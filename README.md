...
- [80-image gallery with full-size downloads](resources/images.md)
...
- A public gallery containing 80 instructional images, separated into Wi-Fi, cabling/fiber, networking, hardware, RAID, schedule, course-tools, and PC-simulator groups.
...
Discord messages, credentials, personal profiles, resumes, raw exports, paid/copyrighted books, and non-image peer attachments are not redistributed here. Instructional images are available in the gallery; screenshots containing account or credential information remain excluded.
